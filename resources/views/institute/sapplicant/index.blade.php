...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View All Service Provider Applicantion</h5>
    ...
    <table class="table  datatable-basic datatable-row-basic">
        <thead>
            <tr>
				...
				<th class="text-center">Applicant Skills</th>
				<th class="text-center">Action</th>
            </tr> 
        </thead>
        <tbody>
            @foreach (Auth::user()->sapplicants as $sapplicant)
			<tr>
				<td class="text-center">{{$sapplicant->job->title}}</td>
				<td class="text-center">{{$sapplicant->s_deposit->service->name}}</td>
                <td class="text-center"><a href="https://api.whatsapp.com/send?phone={{$sapplicant->s_deposit->service->phone}}"><img src="{{asset('whatsapp.png')}}" height="20" width="20" alt=""></a></td>
                <td class="text-center">{{$sapplicant->s_deposit->skill->name}}</td>
                    ...
                    <div class="list-icons">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{route('institute.sapplicant.show',$sapplicant->id)}}" class="dropdown-item"><i class="icon-file-pdf"></i> View Detail</a>

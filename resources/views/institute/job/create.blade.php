...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('institute.job.store')}}"  method="post">
					@csrf
                    <div class="row">
                        <div class="form-group col-md-6">
							<label>Job Title</label>
							<input class="form-control" name="title" type="text" placeholder="" value=""/>
							<input class="form-control" type="hidden" name="institute_id" value="{{Auth::user()->id}}" required/>                          
                        </div>   
                        <div class="form-group col-md-6">
                            <label>Job Location </label>
							<input class="form-control" name="location" type="text" placeholder="e.g. Sargodha,Punjab" value="" required/>
                        </div>  
                        <div class="form-group col-md-6">
                            <label>Job Required Qualification </label>
							<input class="form-control" name="qualification" type="text" placeholder="Job Required Qualification" value="" required/>
                        </div>  
                        <div class="form-group col-md-6">
                        	<label>Job Type</label>
							<select name="type" data-placeholder="Full-Time" class="form-control">
                        ...
                        <div class="form-group col-md-6">
						   ...
						   <select data-placeholder="Category 'as'"  name="category_id"  class="form-control select-minimum" data-fouc required>
                                <option></option>
						...
						<div class="form-group col-md-6">
							...
							<textarea name="summary" id="" cols="30" rows="2" class="form-control"></textarea>

...
@section('title')
    <title>INSTITUTE LOGIN | JOB PORTAL</title>
@endsection
@section('contents')
    ...
    <section class="contact-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-contact contact_form" action="{{route('institute.login')}}"  method="post">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
							...
							<p>Don’t have an account ? <a href="{{route('institute.register')}}" style="color:black;"> Register Now </a> </p>

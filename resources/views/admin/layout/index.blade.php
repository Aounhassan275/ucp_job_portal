	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="{{url('/')}}" class="text-light">
				<h1 class="m-0"><b>ADMIN PANEL MENU</b></h1>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="{{asset('icon.png')}}" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('admin.profile.profile')}}" class="nav-link {{Request::is('admin/candidate/profile')?'active':''}}">
								<i class="icon-user"></i>
								<span>Candidates CV</span>
						...
						<li class="nav-item">
							<a href="{{route('admin.institute.show')}}" class="nav-link {{Request::is('admin/institute')?'active':''}}">
						...
						<li class="nav-item">
							<a href="{{route('admin.messages.index')}}" class="nav-link {{Request::is('admin/message')?'active':''}}">
								<i class="icon-office"></i>
								<span>Message</span>
						...
						<li class="nav-item">
							<a href="{{route('admin.admin.index')}}" class="nav-link {{Request::is('admin/admin')?'active':''}}">
								<i class="icon-office"></i>

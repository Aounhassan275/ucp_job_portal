...
@section('contents')
    ...
    <section class="contact-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-contact contact_form" action="{{route('candidate.candidate.store')}}"  method="post">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <p>Already a member? <a href="{{route('candidate.login')}}" style="color:black;"> Login Here </a> </p>

...
<head>
	...
	<title>{{Auth::user()->name}} CANDIDATE PANEL | OPTL</title>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="{{url('/')}}" class="text-light">
					<h3 class="m-0"><b>Candidate Panel Menu</b></h3>
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="{{route('candidate.logout')}}" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
					</div>
				</li>
			</ul>
		</div>
			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="ml-3 align-self-center">
								<a href="{{route('candidate.profiles.index')}}" class="text-white"><i class="icon-cog3"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						{{-- @if (Auth::user()->type == '1') --}}
							<!-- Main -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Candidate Panel</div> <i class="icon-menu" title="Main"></i></li>
						<li class="nav-item">
							<a href="{{route('candidate.dashboard.index')}}" class="nav-link {{Request::is('admin/dashboard')?'active':''}}">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="{{route('candidate.dashboard.index')}}"><i class="icon-arrow-left52 mr-2"></i></a><span class="font-weight-semibold">@yield('title')</span></h4>

...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('candidate.candidate.update',Auth::user()->id)}}"  method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                       ...
                       <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="cnic" maxlength="15" minlength="15" id="cnic"  class="form-control " value="{{Auth::user()->cnic}}" readonly>
                        </div>
                            <div class="form-group col-6">
